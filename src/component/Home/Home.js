...
import tacoChar from "./taco-crawling-char.png";
		...
		return (
			<div className='parentContainer'>
				<div className='home-image'>
					<img src={tacoChar} alt='taco character' />
				</div>
				<div className='intro-text'>
					...
					<p className='p-main'>
						...
						<span className='spanHighlight'> you’ll be crawling</span> from
